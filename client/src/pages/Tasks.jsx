...
const tasksHelpTips = [
  ...
  },
  {
    ...
    description: 'Tlačidlo 📤 pri projekte alebo úlohe otvorí okno, kde v dvoch krokoch vyberiete cieľové kontakty a cieľ a zvolíte Kopírovať alebo Presunúť. Pri podúlohe sú tri možnosti cieľa: 🗂️ „Ako v origináli" (predvolená) — kópia pristane na rovnakom mieste ako u zdroja: vo vlastnom projekte kontaktu, v úlohe s rovnakým názvom (ak ju kontakt nemá, chýbajúca časť štruktúry sa dovytvorí); ➕ „Ako nový projekt" — kópia sa stane samostatným projektom; výber KONKRÉTNEHO projektu — ručné umiestnenie, kópia sa vloží ako nová úloha navrch zvoleného projektu (rovnako pomenovaná úloha sa nehľadá). Kopírovať sa dá aj do VIACERÝCH kontaktov naraz (max 25). Kontakty, ktoré už kópiu danej položky majú, sú označené „✓ už má kópiu" a nedajú sa vybrať znova. Kópia prenesie aj prílohy, termíny a priradenia; v detaile nesie odkaz „📌 Skopírované z" na originál. Presun položku premiestni aj so všetkými podúlohami — ten má vždy jeden cieľ.'
  },
  {
    icon: '🏁',
